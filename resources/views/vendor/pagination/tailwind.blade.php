@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class=" ml-[200px] items-center ">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center ml-[220px] ">
            <div>
                <p class="text-sm text-black font-weight-bold leading-5">
                    {!! __('Showing') !!}
            ...
            <div>
                <span class="relative z-0 inline-flex shadow-md rounded-md ml-[150px]">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
