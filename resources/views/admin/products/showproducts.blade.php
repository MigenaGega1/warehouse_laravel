            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <a href="/products/create" class="btn btn-secondary"><span> + Add New Product</span></a>
                ...
                <table class="table table-striped table-hover ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/products/{{$product->id}}/edit" class="settings" title="Settings" data-toggle="tooltip">
...
<div class="items-center text-lg">
    ...
    <div class="col-sm-7">
        <a href="/products/create" class="btn btn-secondary"><span>Create New product</span></a>
